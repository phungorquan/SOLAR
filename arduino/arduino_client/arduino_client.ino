...
const char* ssid = "UIT Public";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
     
char host[] = "10.45.15.38";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
...
void setup(){
    ...
    if (client.connected()) {
        ...
        client.send("connection", "{\"ten\":\"thuc\"}");
    }
...
void loop(){
    ...
    if (millis() - previousMillis > interval) {
        ...
        client.send("atime", "{\"req\": \"tt\", \"ros\": \"ff\"}");
    }
